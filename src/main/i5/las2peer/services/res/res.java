...
public class res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "405", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-405/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response method() {
    ...
    if(res_condition) {
      ...
      return Response.status(HttpURLConnection.HTTP_OK).entity(resutl.toJSONString()).build();
    }
    return null;
  }
